        ...
        <main className="main-content">
          <section className="seat-map">
            <span style={{ display: "inline" }}>
              <div style={{}}>CHIỀU ĐI</div>
              <div style={{ color: "black" }}>   {goFlight?.departure_code}-{goFlight?.arrival_code}      ~        {goFlight?.departure_time}</div>
            </span>
          ...
          <div className="choosing-container">
            <main className="main-content">
              ...
              <section className="seat-map">
                <span style={{ display: "inline" }}>
                  <p style={{}}>CHIỀU VỀ</p>
                  <p style={{ color: "black" }}>{returnFlight?.departure_code}-{returnFlight?.arrival_code}                 ~                  {returnFlight?.departure_time}</p> </span>
                <div className="legend">
                  <span style={{ padding: "10px" }}><b>Business</b></span>
                  <span>
                    <div className="box businessEmpty"></div> <p style={{ margin: "0", padding: "10px" }}> Ghế trống</p>
