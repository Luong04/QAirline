  ...
  return (
    <div>
      ...
      <div className="choosing-container">
        <main className="main-content">
          <section className="seat-map">
            ...
            <div style={{ color: "gray", fontWeight: "bold", margin: "50px auto" }}><span style={{ color: "black" }}>CHIỀU ĐI: </span>Hà Nội - Đà Nẵng 06:45 · 11/12/2024</div>
          ...
          <section className="info">
            ...
            <div className="info-returnflight">
              <h2>CHIỀU VỀ</h2>
            <div className="row-price">
            <div className="container-price">
              <p>Phổ thông</p>
      ...
      <div className="choosing-container">
        <main className="main-content">
          <section className="seat-map">
            <div style={{ color: "gray", fontWeight: "bold", margin: "50px auto" }}><span style={{ color: "black" }}>CHIỀU VỀ: </span>Hà Nội - Đà Nẵng 06:45 · 11/12/2024</div>
            <div className="legend">
              <span style={{ padding: "10px" }}><b>Business</b></span>
              <span style={{}}>
                <div className="box businessEmpty"></div> <p style={{ margin: "0", padding: "10px" }}> Ghế trống</p>
